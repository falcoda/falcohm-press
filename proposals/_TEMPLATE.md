...
## 1. Ce dont nous avons parlé
{{RESUME_VISIO}}

## 2. Ce que vous apportez
| Poste | Détail | Valeur estimée |
|---|---|---|
| | | |
| | | **Total** |
...
|---|---|---|
| Technique | Marquage permanent sur les caissons | Photos du matériel marqué |
...
| Quand | Quoi |
|---|---|
| À la signature | Annonce du partenariat (réseaux, {{FOLLOWERS}} abonnés) |
| Fabrication | Contenus making-of |
| Première date | Photos du matériel en usage, mention dans l'aftermovie |
| Fin de saison | Bilan chiffré des contreparties livrées |

## 5. Engagement de notre côté
Chaque contrepartie livrée est **documentée et prouvée** : capture, photo, chiffre. Si nous ne
